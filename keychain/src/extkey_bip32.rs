...
//! Modified from above to integrate into bitgrin and allow for different
...
/// BitGrin uses blake2 everywhere but the spec calls for SHA512/Ripemd160, so allow
...
#[derive(Clone, Debug)]
pub struct BIP32BitGrinHasher {
	is_floo: bool,
	hmac_sha512: Hmac<Sha512>,
}

impl BIP32BitGrinHasher {
	/// New empty hasher
	pub fn new(is_floo: bool) -> BIP32BitGrinHasher {
		BIP32BitGrinHasher {
			is_floo: is_floo,
...
impl BIP32Hasher for BIP32BitGrinHasher {
	fn network_priv(&self) -> [u8; 4] {
		match self.is_floo {
...
impl ExtendedPrivKey {
	...
	pub fn from_mnemonic(
		...
		let mut hasher = BIP32BitGrinHasher::new(is_floo);
