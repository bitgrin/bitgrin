...
//! patterns that are frequent within the bitgrin codebase.
...
/// Global stopped/paused state shared across various subcomponents of BitGrin.
///
...
///
/// "Stopped" allows a clean shutdown of the BitGrin server.
