...
#[derive(Clone)]
pub struct SlatepoolWalletCommAdapter {}

impl SlatepoolWalletCommAdapter {
	/// Create
	pub fn new() -> Box<SlatepoolWalletCommAdapter> {
		Box::new(SlatepoolWalletCommAdapter {})
	}
}

impl WalletCommAdapter for SlatepoolWalletCommAdapter {
