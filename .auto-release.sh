...
if [[ $TRAVIS_OS_NAME == 'osx' ]]; then
    ...
    cd target/release ; rm -f *.tgz; tar zcf "bitgrin-$tagname-$TRAVIS_JOB_ID-osx.tgz" grin
    ...
    cd target/release ; rm -f *.tgz; tar zcf "bitgrin-$tagname-$TRAVIS_JOB_ID-linux-amd64.tgz" grin
    /bin/ls -ls *.tgz  | awk '{print $6,$7,$8,$9,$10}'
