...
pub fn genesis_main() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		height: 0,
timestamp: Utc.ymd(2019, 2, 6).and_hms(0, 55, 5),
prev_root: Hash::from_hex("0000000000000000002ca2aabca1b0ee52e73ed8e1bfc61d8a0933b0589e338f").unwrap(),
...
kernel_root: Hash::from_hex("372eff9b57d34c0ee7f5a97b25ea3e842a3a1761607d2b07cfcd7440a441df39").unwrap(),
...
nonce: 84,
			proof: Proof {
nonces: vec![4883078, 13291050, 20637734, 28556214, 37883343, 52937859, 63758875, 64067519, 83673951, 92869969, 102830781, 115013759, 147386085, 153857592, 158289270, 190737211, 204831945, 214533514, 215286933, 224340014, 224733694, 231928319, 232166889, 260268490, 289627482, 312760616, 331047279, 336029296, 340756217, 345008081, 364653737, 367581449, 370202222, 374211203, 410039969, 413780853, 455660264, 460113109, 462215427, 463244452, 478143313, 491448943],
				edge_bits: 29,
			},
		},
		..Default::default()
...
excess_sig: Signature::from_raw_data(&[31, 79, 187, 5, 3, 143, 128, 49, 76, 213, 130, 74, 99, 142, 20, 131, 227, 4, 237, 118, 69, 139, 201, 20, 100, 33, 89, 228, 196, 35, 16, 131, 24, 7, 179, 255, 114, 110, 70, 148, 73, 68, 223, 221, 1, 86, 209, 55, 3, 206, 10, 21, 126, 173, 25, 204, 124, 127, 212, 174, 73, 45, 114, 64]).unwrap(),
	};
	let output = core::Output {
		features: core::OutputFeatures::Coinbase,
