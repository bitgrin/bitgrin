...
their 2 children. BitGrin uses the Blake2b hash function throughout, and always
...
In BitGrin, a lot of the data that gets hashed and stored in MMRs can eventually
