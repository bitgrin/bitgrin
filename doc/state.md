...
The full state of a BitGrin chain consists of all the following data:
...
With a full BitGrin state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in BitGrin is simple: a plain
